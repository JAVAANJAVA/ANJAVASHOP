...
<header class="header">
    ...
    <div class="icons">
        ...
        <a href="/src/main/webapp/Shopping/Member/userinfo.insert.html"><div class="bx bx-group" id="cart-btn"></div></a>
        <a href="/src/main/webapp/Shopping/Member/userlogin.html"><div class="bx bx-log-in" id="login-btn"></div></a>
    </div>
